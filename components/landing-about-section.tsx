      ...
      <section className='relative py-40 xl:py-30 2xl:py-40 px-4 bg-muted/30 before:content-[""] before:absolute before:top-0 before:left-0 before:w-full before:h-32 before:bg-gradient-to-b before:from-5% after:to before:from-[#060912] before:to-transparent before:pointer-events-none before:z-10 after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-full after:h-32 after:bg-gradient-to-t after:from-[#060912] after:to-transparent after:pointer-events-none after:z-10'>
        <div className='container mx-auto max-w-4xl'>
          ...
          <ScrollAnimation variant='fadeUp' delay={0.2}>
            <p className='text-lg md:text-xl text-secondary text-center leading-relaxed'>
